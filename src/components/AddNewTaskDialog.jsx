...
const AddNewTaskDialog = ({ open, onClose, stageId, onTaskAdded, consultingCompanyId, participants }) => {
  ...
  const { engineers: consultingEngineers, loading: engineersLoading } = useConsultingEngineersData({ consultingCompanyId: consultingCompanyId });
      ...
      <DialogContent sx={{ backgroundColor: colors.primary[800], pt: '20px !important' }}>
        <Box component="form" noValidate sx={{ mt: 2 }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <TextField name="title" label="Task Title" value={formData.title} onChange={handleChange} error={!!errors.title} helperText={errors.title} fullWidth required sx={inputStyles} InputProps={{ startAdornment: <InputAdornment position="start"><TitleIcon /></InputAdornment> }} />
            </Grid>
            <Grid item xs={12}>
              <TextField name="description" label="Description" value={formData.description} onChange={handleChange} error={!!errors.description} helperText={errors.description} fullWidth required multiline rows={3} sx={inputStyles} InputProps={{ startAdornment: <InputAdornment position="start"><DescriptionIcon /></InputAdornment> }} />
            </Grid>
            <Grid item xs={12}>
              <TextField name="note" label="Additional Notes" value={formData.note} onChange={handleChange} error={!!errors.note} helperText={errors.note} fullWidth required multiline rows={2} sx={inputStyles} InputProps={{ startAdornment: <InputAdornment position="start"><SpeakerNotesIcon /></InputAdornment> }} />
            </Grid>
          </Grid>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <TextField name="start_date" label="Start Date" type="date" value={formData.start_date} onChange={handleChange} error={!!errors.start_date} helperText={errors.start_date} fullWidth required InputLabelProps={{ shrink: true }} sx={inputStyles} InputProps={{ startAdornment: <InputAdornment position="start"><EventIcon /></InputAdornment> }} />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField name="dead_line" label="Deadline" type="date" value={formData.dead_line} onChange={handleChange} error={!!errors.dead_line} helperText={errors.dead_line} fullWidth required InputLabelProps={{ shrink: true }} sx={inputStyles} InputProps={{ startAdornment: <InputAdornment position="start"><EventIcon color="error" /></InputAdornment> }} />
            </Grid>
          </Grid>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth required error={!!errors.employee_assigned} sx={{ ...inputStyles, minWidth: 220 }}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth required error={!!errors.supervisor_id} sx={{ ...inputStyles, minWidth: 220 }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth required error={!!errors.status} sx={{ ...inputStyles, minWidth: 220 }}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth required error={!!errors.type_of_task} sx={{ ...inputStyles, minWidth: 220 }}>
            ...
            <Grid item xs={12} sm={12} md={4}>
              <TextField name="priority" label="Priority (1-5)" type="number" value={formData.priority} onChange={handleChange} error={!!errors.priority} helperText={errors.priority} fullWidth required InputProps={{ inputProps: { min: 1, max: 5 }, startAdornment: <InputAdornment position="start"><LowPriorityIcon /></InputAdornment> }} sx={inputStyles} />
            </Grid>
          </Grid>
